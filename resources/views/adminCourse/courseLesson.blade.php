                ...
                <div id="lesson_title_area" class="mb-4">
                    <div class="flex items-center justify-between pb-3 my-4 mt-5 border-b-2 border-seagreen">
                        ...
                        <div id="edit_lesson_btns" class="hidden">
                            <button id="save_lesson_btn" data-lesson-id="{{$lessonInfo->lesson_id}}" data-course-id="{{$lessonInfo->course_id}}" data-topic_id="{{$lessonInfo->topic_id}}" data-syllabus-id="{{$lessonInfo->syllabus_id}}" class="px-5 py-3 text-white rounded-xl bg-darthmouthgreen hover:bg-green-800">
                                Save
                            </button>
                ...
                <div class="mt-5">
                    ...
                    <div id="lesson_img" class="flex justify-center w-full h-[400px] my-4 rounded-lg shadow">
                        ...
                        <div id="edit_lesson_picture_btns" style="position: relative; top: 75%;" class="flex justify-end hidden">
                            <button id="" data-lesson-id="{{$lessonInfo->lesson_id}}" data-course-id="{{$lessonInfo->course_id}}" data-topic_id="{{$lessonInfo->topic_id}}" data-syllabus-id="{{$lessonInfo->syllabus_id}}" class="flex px-5 py-3 mr-3 text-white add_lesson_picture_btn rounded-xl bg-darthmouthgreen hover:bg-green-800">
                                Change Photo
                            </button>
                        </div>
                        @else
                    ...
                    <div class="flex justify-center w-full">
                        <button id="editLessonBtn" data-course-id="{{$lessonInfo->course_id}}" data-syllabus-id="{{$lessonInfo->syllabus_id}}" data-topic_id="{{$lessonInfo->topic_id}}"
