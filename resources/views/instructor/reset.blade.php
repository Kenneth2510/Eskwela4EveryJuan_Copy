        ...
        <div class="w-full h-full m-auto">
            ...
            <div class="flex flex-col items-center justify-center h-full p-20">
                ...
                <p class="mt-5 text-xs text-darthmouthgreen md:text-base">
                    <span class="font-bold">Hello {{ $instructor->instructor_fname }} {{ $instructor->instructor_lname }}!</span> You're now on the page to change your password. Please enter a new password below to secure your account.
                    If you did not initiate this password change request, you can ignore this page.
                </p>
                <div class="w-full mt-16">
                    <form class="" action="{{ url("/instructor/reset_password_process/$token->token") }}" method="POST"> 
                        @csrf
