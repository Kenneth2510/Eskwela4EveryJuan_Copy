    ...
    <section class="w-full h-auto md:h-screen md:w-3/4 lg:w-10/12">
        <div class="h-full px-2 py-4 pt-24 rounded-lg shadow-lg md:overflow-hidden md:overflow-y-scroll md:pt-0">
            ...
            <div class="flex flex-col justify-between space-y-2 md:flex-row md:space-x-2 md:space-y-0" id="learnerSyllabusChartsArea">
                ...
                <div class="md:w-1/3 h-[350px] border-2 border-darthmouthgreen" id="learnerSyllabusStatusChartArea">
                    <canvas id="learnerSyllabusStatusChart"></canvas>
                </div>

                <div class="md:w-1/3 h-[350px] border-2 border-darthmouthgreen" id="learnerSyllabusStatusTimeChartArea">
                    <canvas id="learnerSyllabusStatusTimeChart"></canvas>
                </div>

                <div class="md:w-1/3 h-[350px] border-2 border-darthmouthgreen" id="learnerSyllabusAttemptNumberChartArea">
            ...
            <h1 class="mb-5 text-2xl ">Activity Outputs</h1>
            <div class="flex flex-col justify-between space-y-2 mb:flex-row md:space-x-2 md:space-y-0" id="learnerSyllabusOutputChartsArea">

                <div class="md:w-1/2 h-[350px]  border-2 border-darthmouthgreen" id="learnerSyllabusOverallScoreChartArea">
                    <canvas id="learnerSyllabusOverallScoreChart"></canvas>
                </div>

                <div class="md:w-1/2 h-[350px]  border-2 border-darthmouthgreen" id="learnerSyllabusCriteriaScoreChartArea">
            ...
            <div class="flex flex-col w-full mt-5 overflow-auto" id="learnerSyllabusProgressTableArea">
                <table class="w-full mt-5 table-fixed">
                    <thead class="py-3 text-xl text-white bg-darthmouthgreen">
                        ...
                        <th class="w-[130px]">Start Period</th>
                        <th class="w-[130px]">Finish Period</th>
                        <th class="w-[130px]"></th>
                    </thead>
