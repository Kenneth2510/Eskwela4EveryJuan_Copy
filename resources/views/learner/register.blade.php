            ...
            {{-- <form class="pb-4 mx-4 mt-10 text-sm" action="{{ url('/learner/register') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="text-black" id="first-form">
                    ...
                    <div class="grid h-auto mt-5 text-black place-items-end" >
                        <button class="btn btn-primary" id="nxtBtn" name="Next">Next <i class="fa-solid fa-arrow-right hover:text-darthmouthgreen"></i></button>
                    </div>
                </div> 
                
                <div class="hidden overflow-hidden text-black" id="resumeForm">
                    ...
                    <div class=" FORM-CTNR">
                        ...
                        <select class="text-black w-full select select-bordered"
                    ...
                    <div class=" FORM-CTNR">
                        ...
                        <select name="business_classification" id="business_classification" class="w-full select select-bordered">
                            <option value="" selected disabled>-- select an option --</option>
                            <option value="Retail">Retail</option>
                            <option value="Wholesale">Wholesale</option>
                            <option value="Food">Food</option>
                    ...
                    <div class="">
                        ...
                        <div class="grid h-auto my-10 text-black place-items-end" >
                            <div class="flex space-x-2" >
                                ...
                                <button class="btn btn-ghost" id="prevBtn" name="Back"><i class="fa-solid fa-arrow-left hover:text-darthmouthgreen"></i>Back</button>
                                <button class="btn btn-primary" id="nxtBtn2" name="Next">Next <i class="fa-solid fa-arrow-right hover:text-darthmouthgreen"></i></button>
                            </div>
                    ...
                    <div class="">
                        ...
                        <div class="grid h-auto mt-5 text-black place-items-end" >
                            <div class="flex space-x-2">
                                ...
                                <button class="btn btn-ghost" id="prevBtn2" name="Back"><i class="fa-solid fa-arrow-left hover:text-darthmouthgreen"></i>Back</button>
