            ...
            <div class="flex" id="upper_container">
                ...
                <div class="flex flex-col items-center justify-start w-3/12 h-full py-10 mx-5 bg-white rounded-lg shadow-lg" id="upper_left_container">
                    ...
                    <div class="mt-10 text-center" id="email_area">
                        ...
                        <a href="{{ url('/learner/message') }}?email={{ $learner->learner_email }}&type=Learner" class="px-5 py-3 mt-10 text-lg text-white bg-darthmouthgreen hover:border-2 hover:bg-white hover:border-darthmouthgreen hover:text-darthmouthgreen rounded-xl">Send Message</a>
                    </div>
                </div> 
