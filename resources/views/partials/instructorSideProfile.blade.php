    ...
    <div class="float-right w-3/4 h-screen py-4 bg-white">
        ...
        <div class="w-full py-4">
            <ul class="flex flex-col justify-center divide-y-2">
                <li class="p-3 hover:bg-darthmouthgreen hover:bg-opacity-75 hover:text-white profile"><a href="">Profile Setting</a></li>
                <li class="p-3 hover:bg-darthmouthgreen hover:bg-opacity-75 hover:text-white"><a href="">Chatbot Helper</a></li>
                <li class="p-3 hover:bg-darthmouthgreen hover:bg-opacity-75 hover:text-white"><a href="">Sidebar 1</a></li>
            </ul>
