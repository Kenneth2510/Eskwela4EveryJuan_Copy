$(document).ready(function() {
    ...
    $('#editLessonBtn').on('click', function(e) {
        ...
        var url = "/admin/courseManage/content/"+ courseID +"/"+ syllabusID +"/lesson/"+ topicID +"/json";

        console.log(url)

        $.ajax ({
            type: "GET",
            url: "/admin/courseManage/content/"+ courseID +"/"+ syllabusID +"/lesson/"+ topicID +"/json",
            dataType: 'json',
...
`;
        ...
        const url = "/admin/courseManage/content/"+ courseID +"/"+ syllabusID +"/lesson/"+ topicID +"/title/"+ lessonID +"/store_file/"+ lesson_contentID;
        ...
        $('#confirmDelete_lessonContentPicture').on('click', function(e) {
            ...
            const url = "/admin/courseManage/content/"+ courseID +"/"+ syllabusID +"/lesson/"+ topicID +"/title/"+ lessonID +"/delete_file/"+ lesson_contentID;
            // console.log(url)
            $.ajax({
                type: "POST",
                url: url,
...
$('#save_lesson_btn').on('click', function(e) {
    ...
    var url = "/admin/courseManage/content/" + courseID + "/" + syllabusID + "/lesson/" + topicID + "/title/" + lessonID;
    ...
    $('#saveEditBtn').on('click', function(e){
        ...
        for (let i = 0; i < lessonData.length; i++) {
            ...
            if (!/^none\d+$/.test(row_lesson_content_data['lesson_content_id'])) {
                ...
                const url = "/admin/courseManage/content/"+courseID+"/"+syllabusID+"/lesson/"+topicID+"/title/"+ lessonID +"/save"
                // console.log(url)
                ...
                const url = "/admin/courseManage/content/"+courseID+"/"+syllabusID+"/lesson/"+topicID+"/title/"+ lessonID +"/save_add";
        ...
        if(loopCounter == lessonData.length) {
            const url = "/admin/courseManage/content/"+courseID+"/"+syllabusID+"/lesson/"+topicID+"/title/"+ lessonID +"/generate_pdf";
    ...
    $('#pictureUploadForm').on('submit', function(e){
        ...
        var formData = new FormData(this);
        const url = "/admin/courseManage/content/"+ courseID +"/"+ syllabusID +"/lesson/"+ topicID +"/title/"+ lessonID +"/picture"
