...
return new class extends Migration
{
    ...
    {
        Schema::create('learner_post_assessment_progress', function (Blueprint $table) {
            $table->id('learner_post_assessment_progress_id');
            $table->unsignedBigInteger('learner_course_id');
            $table->unsignedBigInteger('learner_id');
            $table->unsignedBigInteger('course_id');
            $table->string('status')->default('NOT YET STARTED');
            $table->bigInteger('max_duration')->default(5400000);
        ...
        Schema::create('learner_post_assessment_output', function (Blueprint $table) {
            $table->id('learner_post_assessment_output_id');
            $table->unsignedBigInteger('learner_course_id');
            $table->unsignedBigInteger('learner_id');
            $table->unsignedBigInteger('course_id');
    ...
    {
        Schema::dropIfExists('learner_post_assessment_progress');
        Schema::dropIfExists('learner_post_assessment_output');
    }
};
